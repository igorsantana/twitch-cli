            ...
            inquirer
              ...
              .then(aliasAnswer => {
                ...
                inquirer
                  ...
                  .then(alias => {
                    configAlias.alias[alias.Alias] = streamAnswer.Streams
                    alias.save(configAlias.alias, (err, data) => {
                      if(!err){
                        log(`Next time you'd like to open ${streamAnswer.Streams.channelName}'s stream, just type "twitch watch ${alias.Alias}"`)
                        open(streamAnswer.Streams.url)
                      } else {
                        console.log(err);
                      }
